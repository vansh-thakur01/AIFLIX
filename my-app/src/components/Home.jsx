    ...
    return (
      ...
      <div className="flex justify-center  mt-35 ">
        ...
        <div className="text-[18px] w-dvw font-semibold text-center text-white/85 relative z-10 ">
          ...
          <h2 className="mb-9">{lang[selectedLang].aiHeading}</h2>
        ...
        <div className="flex justify-center">
          <div className="relative w-[380px]  h-[80px] overflow-hidden">
        ...
        <footer className={`text-[11px] relative z-20 flex justify-center ${selectedLang === "hindi" ? "mt-16" : "mt-23"}`}>
          <div>
